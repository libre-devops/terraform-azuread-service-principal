variable "spns" {
  ...
  type = list(object({
    ...
    federated_credential_description    = optional(string)
    ...
    client_secret_display_name          = optional(string)
    client_secret_start_date            = optional(string)
    client_secret_end_date              = optional(string)
    attempt_put_spn_secret_in_kv        = optional(bool, false)
